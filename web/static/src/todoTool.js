...
import { applyFieldLayout, fieldHasValue, buildRelativeDateOptions, parseDateInput } from './toolUtils.js';
...
function renderTodoActionForm(action) {
  ...
  fields.forEach((field) => {
    ...
    const required = isFieldRequired(action, field);
    ...
    if (field === 'id') {
      ...
      if ((fieldConfig.type || control.tagName) !== 'TEXTAREA') {
        control.type = 'text';
      }
